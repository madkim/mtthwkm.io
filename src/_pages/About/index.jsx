  ...
  return (
    <Container id="about" className='d-flex flex-column justify-content-center align-items-center text-light'>
      ...
      <div id='about__short' className='container lead'>
        <p>Hi  <i className='fa-solid fa-hand-wave'></i>  I'm so glad you made it. </p><br/>
        <p>My name is Matthew Kim and I was born and raised in Redlands California.</p><br/>
        <p>In 2017 I graduated from the University of California Santa Cruz with a bachelors degree in Computer Science. </p><br/>
        <p>For work I build web applications and websites ( like this one! ) in Javascript and React.js. I love design and making things feel good! There's a joy in taking an idea and molding it into something real that people can use and interact with. Often times I find myself thinking of little things. For better or worse, small details add up and whether or not others explicitly notice, they will feel it. </p><br/>
        <p>In my free time you can find me enjoying the great outdoors. I'm an avid music listener, coffee drinker, art appreciator, and rock climber. My favorite color is orange and I'm a father of 2 cats and a dog, all of which I love equally in their own way. </p><br/>
        <p>Now you know a little bit about me! <Link to='/contact' className='text-decoration-none'>Tell me about yourself!</Link></p><br/>
      </div>

      <div id='about__long' className='container lead'>
        <p>Hi  <i className='fa-solid fa-hand-wave'></i>  I'm so glad you made it. </p><br/>
        <p>My name is Matthew Kim and I was born and raised in Redlands California.</p><br/>
        <p>Growing up I always found myself comfortable with computers. My grandparents use to tell me as a child I always knew what to do when it came to helping them troubleshoot issues (much like most grandkids!). I suppose I never thought much about it but thinking back it probably did affect me pursuing a career in computer science. </p><br/>
        ...
        <p>Working for AxS Health, I've been able to hone my skills in front end development. </p><br/>
      </div>

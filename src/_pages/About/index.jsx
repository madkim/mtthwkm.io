  ...
  return (
    <Container id="about" className='d-flex flex-column justify-content-center align-items-center text-light'>
          ...
          <h1>
            ...
            <ul className='about__items'>
              ...
              <li 
                ...
                className='about__item about__timeline'>see a cool timeline thingy</li>
            </ul>
          </h1>
        </Col>
      </Row>
      ...
      <div id='about__short' className='container lead'>
        <p>Hi  <i className='fa-solid fa-hand-wave'></i>  I'm so glad you made it. </p>
        <p>My name is Matthew Kim and I was born and raised in Redlands California.</p>
        ...
        <p>Now you know a little bit about me! <Link to='/contact' className='text-decoration-none'>Tell me about yourself!</Link></p>
      </div>

      <div id='about__long' className='container lead'>
        <p>Hi  <i className='fa-solid fa-hand-wave'></i>  I'm so glad you made it. </p>
        <p>My name is Matthew Kim and I was born and raised in Redlands California.</p>
        <p>Growing up I always found myself comfortable with computers. My grandparents use to tell me as a child I always knew what to do when it came to helping them troubleshoot issues (much like most grandkids!). I suppose I never thought much about it but thinking back it probably did affect me pursuing a career in computer science. </p>
